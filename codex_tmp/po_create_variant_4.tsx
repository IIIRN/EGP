        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white p-4 pt-6 shadow-lg sticky top-0 z-40 flex items-center overflow-hidden">
                ...
                <div className="relative z-10">
                    <h1 className="text-lg font-black leading-tight tracking-tight">สร้างใบสั่งซื้อ (PO)</h1>
                    <p className="text-[10px] text-blue-100 font-bold uppercase tracking-widest">{currentProject.name}</p>
                </div>
            </div>
